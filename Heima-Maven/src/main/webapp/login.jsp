...
#span{
	...
	<script type="text/javascript">
		...
		/*$(function (){
			// 当用户名文本框获取到焦点后，span内容隐藏
			//$("#username").onfocus;
			$("#username").click(hideSpan());
		})*/
	</script>
</head>
<body>
			...
			<div class="col-md-5">
				<div
					...
					<div id="div" align="center">
						<%--判断errorMsg是否为空，不为空表示没有登录成功--%>
						<%--<c:if test="${!empty errorMsg}">--%>
							<span id="span" >${errorMsg}</span>
						<%--</c:if>--%>
					</div>
					...
					<form class="form-horizontal" action="${pageContext.request.contextPath}/user/login" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								...
								<input type="text" class="form-control" id="username" name="username" onclick="hideSpan()"
									placeholder="请输入用户名">
