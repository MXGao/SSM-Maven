...
.carousel-inner .item img {
	...
	<script type="text/javascript">
			// 为添加购物车添加鼠标单击事件,单击后调用该函数
			function addCart(){
				// 需要获取数量和商品的pid
				var count = $("#quantity").val();
				var pid = ${product.pid};
				location.href="${pageContext.request.contextPath}/product/addCart?count="+count+"&pid="+pid+"";
			};
	</script>
</head>
	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="${pageContext.request.contextPath}/index.jsp">首页&nbsp;&nbsp;&gt;</a> <a href="${pageContext.request.contextPath}/product/productShow?cid=${product.cid}">蔬菜&nbsp;&nbsp;&gt;</a>
				<a>${product.pname}</a>
			</div>
